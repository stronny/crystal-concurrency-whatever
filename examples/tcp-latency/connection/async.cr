class Connection
	...
	protected def interrupt_blocking_call(state : State::Free) : Nil; raise "free state" end
	protected def interrupt_blocking_call(state : State::Sleeping) : Nil; @jiber.resume_event.add ZERO_SECONDS end
