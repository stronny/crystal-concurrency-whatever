class Influx
	...
	protected def read_reply(socket : Nothing) : HTTP::Client::Response; raise "no socket" end
	...
	protected def write_measurements(socket : Nothing) : Bool; raise "no socket" end
